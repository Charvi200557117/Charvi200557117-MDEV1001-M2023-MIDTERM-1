...
class DataViewController: UIViewController, UITableViewDelegate
{
    ...
    func fetchData()
    {
        ...
        let fetchRequest: NSFetchRequest<SportsTeams> = SportsTeams.fetchRequest()
    ...
    // New for ICE5
       ...
       func ShowDeleteConfirmationAlert(for movie: SportsTeams, completion: @escaping (Bool) -> Void)
       {
